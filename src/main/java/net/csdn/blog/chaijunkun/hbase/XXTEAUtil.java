...
public class XXTEAUtil {
	...
	public static final String PASSWORD= "7GP^=qXV83H#2~p%";
	...
	public static String encrypt(String plain){
		return XXTEAUtil.encrypt(plain, PASSWORD);
	}
	...
	public static String decrypt(String cipher){
		return XXTEAUtil.decrypt(cipher, PASSWORD);
	}
	...
	public static String encrypt(String plain, String key) {
		...
		replacement = new String(Base64.encodeBase64(XXTEAUtil.encrypt(v, k)));
